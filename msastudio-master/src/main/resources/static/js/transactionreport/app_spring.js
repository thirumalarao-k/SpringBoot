...
app.controller('MainCtrl', ['$scope', '$http', '$log', function ($scope, $http, $log) {
  ...
  $http.get('transactionReportJSON?projectId='+$scope.pId+'&technology='+$scope.tId)//
	        ...
	        for(j = 0; j < methods.length; j++){
	        	methods[j].subGridOptions = {
		          columnDefs: [ {name:"Id", field:"id", width: '5%'},        	 
		        	  ...
		        	  {name:"Compensating Service", field:"compensatingService", width: '17%'}
		        	  ],
		        ...
		        data[i].subGridOptions = {
		          columnDefs: [ {name:"Id", field:"id", width: '5%'},
		        	  {name:"Transactional Functionality", field:"methodName", width: '20%',cellTemplate: '<div>' +
