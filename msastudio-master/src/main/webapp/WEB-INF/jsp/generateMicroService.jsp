...
<p>&nbsp;</p>
    ...
    <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <div class="panel-heading"><Strong>Generate Micro Service</Strong></div>
    </div>
				<form method="post" action="/generateMicroService1">
			  ...
			  <div class="form-group">
              <label for="projectupload" class="col-xs-5">Project Upload</label>
              <div class="col-xs-6">
