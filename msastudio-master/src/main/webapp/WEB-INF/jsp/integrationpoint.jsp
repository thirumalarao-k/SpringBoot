...
function chooseProject(projects) {
		...
		document.location = "integrationpoint/" +projectId;
		return true;
}
...
<div style="width:100%;align=center; margin: auto;" class="panel panel-success text-center">
      <div class="panel-heading"><Strong>Integration Points Analysis Report</Strong></div>
    </div>
      ...
      <tbody>
         <tr>
            <td colspan="2" align="center">
				...
				<form method="post" action="<c:out value='${pageContext.servletContext.contextPath}' />/integrationreport">
